...
declare -A best_nifa_paths=(
  [bail]="logs/tune_vanilla_nifa/bail/gat/vanilla/attack_balanced/20251109-162001_nifa/best_overall.json"
  [pokec_z]="logs/tune_vanilla_nifa/pokec_z/gat/vanilla/attack_balanced/20251110-065315_nifa/best_overall.json"
  [pokec_n]="logs/tune_vanilla_nifa/pokec_n/gat/vanilla/attack_balanced/20251109-232512_nifa/best_overall.json"
  [nba]="logs/tune_vanilla_nifa/nba/gat/vanilla/attack_balanced/20251110-152911_nifa/best_overall.json"
  [german]="logs/tune_vanilla_nifa/german/gat/vanilla/attack_balanced/20251110-185527_nifa/best_overall.json"
)
