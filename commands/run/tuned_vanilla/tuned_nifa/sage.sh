...
declare -A best_nifa_paths=(
  [bail]="logs/tune_vanilla_nifa/bail/sage/vanilla/attack_balanced/20251109-162056_nifa/best_overall.json"
  [pokec_z]="logs/tune_vanilla_nifa/pokec_z/sage/vanilla/attack_balanced/20251110-112714_nifa/best_overall.json"
  [pokec_n]="logs/tune_vanilla_nifa/pokec_n/sage/vanilla/attack_balanced/20251109-215800_nifa/best_overall.json"
  [nba]="logs/tune_vanilla_nifa/nba/sage/vanilla/attack_balanced/20251110-200550_nifa/best_overall.json"
  [german]="logs/tune_vanilla_nifa/german/sage/vanilla/attack_balanced/20251111-004634_nifa/best_overall.json"
)
