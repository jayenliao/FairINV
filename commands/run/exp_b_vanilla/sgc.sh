...
declare -A victim_best_paths=(
  ["german"]="best_overall_json/optuna_big/vanilla/sgc/german.json"
  ["bail"]="best_overall_json/optuna_big/vanilla/sgc/bail.json"
  ["nba"]="best_overall_json/optuna_big/vanilla/sgc/nba.json"
  ["pokec_z"]="best_overall_json/optuna_big/vanilla/sgc/pokec_z.json"
  ["pokec_n"]="best_overall_json/optuna_big/vanilla/sgc/pokec_n.json"
)
