...
declare -A strongest_nifa_paths=(
  ["german"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gat/german.json"
  ["bail"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gat/bail.json"
  ["nba"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gat/nba.json"
  ["pokec_z"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gat/pokec_z.json"
  ["pokec_n"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gat/pokec_n.json"
)
