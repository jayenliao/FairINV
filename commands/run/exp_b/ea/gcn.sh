...
declare -A victim_best_paths=(
  ["german"]="best_overall_json/optuna_big/edge_adder/gcn/german.json"
  ["bail"]="best_overall_json/optuna_big/edge_adder/gcn/bail.json"
  ["nba"]="best_overall_json/optuna_big/edge_adder/gcn/nba.json"
  ["pokec_z"]="best_overall_json/optuna_big/edge_adder/gcn/pokec_z.json"
  ["pokec_n"]="best_overall_json/optuna_big/edge_adder/gcn/pokec_n.json"
)
...
# under the SAME encoder/model you are rerunning (gat/edge_adder).
# -------------------------
declare -A strongest_nifa_paths=(
  ["german"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gcn/german.json"
  ["bail"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gcn/bail.json"
  ["nba"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gcn/nba.json"
  ["pokec_z"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gcn/pokec_z.json"
  ["pokec_n"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gcn/pokec_n.json"
)
