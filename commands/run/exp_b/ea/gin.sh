...
declare -A victim_best_paths=(
  ["german"]="best_overall_json/optuna_big/edge_adder/gin/german.json"
  ["bail"]="best_overall_json/optuna_big/edge_adder/gin/bail.json"
  ["nba"]="best_overall_json/optuna_big/edge_adder/gin/nba.json"
  ["pokec_z"]="best_overall_json/optuna_big/edge_adder/gin/pokec_z.json"
  ["pokec_n"]="best_overall_json/optuna_big/edge_adder/gin/pokec_n.json"
)
...
# under the SAME encoder/model you are rerunning (gin/edge_adder).
# -------------------------
declare -A strongest_nifa_paths=(
  ["german"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gin/german.json"
  ["bail"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gin/bail.json"
  ["nba"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gin/nba.json"
  ["pokec_z"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gin/pokec_z.json"
  ["pokec_n"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/gin/pokec_n.json"
)
