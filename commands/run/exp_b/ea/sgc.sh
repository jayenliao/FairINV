...
# under the SAME encoder/model you are rerunning (sgc/edge_adder).
# -------------------------
declare -A strongest_nifa_paths=(
  ["german"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/sgc/german.json"
  ["bail"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/sgc/bail.json"
  ["nba"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/sgc/nba.json"
  ["pokec_z"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/sgc/pokec_z.json"
  ["pokec_n"]="best_overall_json/optuna_nifa_expB/edge_adder_expB/sgc/pokec_n.json"
)
