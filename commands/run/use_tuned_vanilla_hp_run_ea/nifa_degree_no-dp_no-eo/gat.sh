...
declare -A best_paths=(
  [bail]="best_overall_json/vanilla/gat/bail/best_overall.json"
  [pokec_z]="best_overall_json/vanilla/gat/pokec_z/best_overall.json"
  [pokec_n]="best_overall_json/vanilla/gat/pokec_n/best_overall.json"
  [nba]="best_overall_json/vanilla/gat/nba/best_overall.json"
  [german]="best_overall_json/vanilla/gat/german/best_overall.json"
)
...
start_seed=0
seed_num=10
log_dir="logs/tuned_vanilla/nifa_degree_no-dp_no-eo"
