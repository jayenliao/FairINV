...
declare -A best_ea_paths=(
  [bail]="best_overall_json/ea/gin/bail.json"
  [pokec_z]="best_overall_json/ea/gin/pokec_z.json"
  [pokec_n]="best_overall_json/ea/gin/pokec_n.json"
  [nba]="best_overall_json/ea/gin/nba.json"
  [german]="best_overall_json/ea/gin/german.json"
)
