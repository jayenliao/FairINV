...
declare -A best_ea_paths=(
  [bail]="best_overall_json/ea/gat/bail.json"
  [pokec_z]="best_overall_json/ea/gat/pokec_z.json"
  [pokec_n]="best_overall_json/ea/gat/pokec_n.json"
  [nba]="best_overall_json/ea/gat/nba.json"
  [german]="best_overall_json/ea/gat/german.json"
)
