...
echo "Running tuned HPs for 5 datasets x gcn x 10 seeds..."
echo "DRY_RUN=$DRY_RUN"
echo

# -----------------------------
# Tuned best_overall.json paths
# (GCN templates; we swap encoder)
# -----------------------------
...
# If you only tuned GCN and want to reuse it for other backbones:
...
for encoder in gcn; do
  ...
  for dataset in bail pokec_z pokec_n german nba; do
    ...
    # Swap encoder folder: /gcn/ -> /${encoder}/
