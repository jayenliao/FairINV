...
echo "Running tuned HPs for 5 datasets x sage x 10 seeds..."
echo "DRY_RUN=$DRY_RUN"
echo

# -----------------------------
# Tuned best_overall.json paths
# (sage templates; we swap encoder)
# -----------------------------
...
# If you only tuned sage and want to reuse it for other backbones:
...
for encoder in sage; do
  ...
  for dataset in bail pokec_z pokec_n german nba; do
    ...
    # Swap encoder folder: /sage/ -> /${encoder}/
