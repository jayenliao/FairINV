...
# ---- Datasets ----
datasets=(${DATASETS:-pokec_n german bail nba}) # pokec_z
...
declare -A best_paths=(
    ...
    ["bail"]="best_overall_json/optuna_big/vanilla/gat/bail.json"
    ["nba"]="best_overall_json/optuna_big/vanilla/gat/nba.json"
    ["pokec_z"]="best_overall_json/optuna_big/vanilla/gat/pokec_z.json"
    ["pokec_n"]="best_overall_json/optuna_big/vanilla/gat/pokec_n.json"
)
