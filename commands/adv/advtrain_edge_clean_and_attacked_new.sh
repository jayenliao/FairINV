...
ADV_EDGE_K="${ADV_EDGE_K:-8}"               # 0 => fallback to --edge_k (if exists)
...
LOG_ROOT="${LOG_ROOT:-${REPO_ROOT}/logs/advtrain_edge/${LOG_TAG}}"
mkdir -p "${LOG_ROOT}"
...
RUN_BASELINE="${RUN_BASELINE:-1}"  # 1 => also run plain vanilla baseline
